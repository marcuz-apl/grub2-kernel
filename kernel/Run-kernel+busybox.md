# Compiling and Running a Minimal Kernel with Busybox
...
`vmlinux` should exist, if it doesn’t, something went wrong and go back to [build](https://tch1001.github.io/linux/kernel/2023/01/31/minimal-kernel.html#building-the-kernel).
...
## Get Chien Hao Tan’s stories in your inbox
