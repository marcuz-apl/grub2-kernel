...
Please visit the [Grub2/Upgrading](https://help.ubuntu.com/community/Grub2/Upgrading) community documentation for more information and instructions.
...
The description of the major GRUB 2 folders and files is located on the [Grub2/Setup](https://help.ubuntu.com/community/Grub2/Setup#File_Structure) community documentation page.
...
Descriptions of the GRUB 2 options and how to change them are presented on the [Grub2/Setup](https://help.ubuntu.com/community/Grub2/Setup#Configuring_GRUB_2) community documentation page.
...
Run `update-grub` after the change have been made. Special thanks to [McCunha](http://ubuntuforums.org/member.php?u=963887) on Ubuntu Forums for the above tip.
...
GRUB 2 is capable of password-protecting menu editing, access to the GRUB 2 terminal, and specific or all menu entries. It can also limit access to specific entries for specific users, and can encrypt plain-text passwords for increased security. Please refer to the [Grub2/Passwords](https://help.ubuntu.com/community/Grub2/Passwords) community documentation.



## Custom Menu Entries

GRUB 2 allows users to create customized menu selections which will be automatically added to the main menu when `sudo update-grub` is executed. A **40_custom** file is available in */etc/grub.d/* for use or to serve as an example to create other custom menus. Information on building and using custom menus in GRUB 2 is located in the [Grub2/CustomMenus](https://help.ubuntu.com/community/Grub2/CustomMenus) community document.



## Troubleshooting

GRUB 2 provides excellent capabilities for troubleshooting and correcting boot problems from the boot menu or GRUB 2 terminal. Troubleshooting and recovery procedures are detailed in the [Grub2/Troubleshooting](https://help.ubuntu.com/community/Grub2/Troubleshooting) community document which also includes a section [Selected_Problems_and_Bugs](https://help.ubuntu.com/community/Grub2/Troubleshooting#Selected_Problems_and_Bugs).
...
For information on using splash images and changing font colors and menu resolutions, please refer to the [Grub2/Displays](https://help.ubuntu.com/community/Grub2/Displays) community documentation.
...
- | ![grub2.theme.dinxter.png](https://help.ubuntu.com/community/Grub2?action=AttachFile&do=get&target=grub2.theme.dinxter.png) |      | ![grub2.theme.bennett.png](https://help.ubuntu.com/community/Grub2?action=AttachFile&do=get&target=grub2.theme.bennett.png) |
  | ------------------------------------------------------------ | ---- | ------------------------------------------------------------ |
  |                                                              |      |                                                              |
...
Please visit the [Grub2/Installing](https://help.ubuntu.com/community/Grub2/Installing) community documentation. Information concerning upgrades from GRUB 0.97 (Legacy) to GRUB 2 is now located at [Grub2/Upgrading](https://help.ubuntu.com/community/Grub2/Upgrading).
...
For information on this Grub 2 feature, please visit the [Grub2/ISOBoot](https://help.ubuntu.com/community/Grub2/ISOBoot) community documentation page.
...
If you want to use another serial port or if your console uses different settings, you must add a **GRUB_SERIAL_COMMAND** line to specify additional parameters to the *serial* command. The *serial* command in GRUB 2 uses the same syntax as its GRUB Legacy counterpart (documented [here](http://www.gnu.org/software/grub/manual/html_node/serial.html)). For example, for a very common 9600 bit/s (baud) serial line with 8 data bits, 1 stop bit and no parity:
...
Please refer to the article [Grub2OtherOs](https://help.ubuntu.com/community/Grub2 Other Os) community documentation page.
...
- [Grub2/CustomMenus](https://help.ubuntu.com/community/Grub2/CustomMenus)
...
- [Grub2/Submenus](https://help.ubuntu.com/community/Grub2/Submenus)
- [Grub2/Troubleshooting](https://help.ubuntu.com/community/Grub2/Troubleshooting)
- [Grub2/Upgrading](https://help.ubuntu.com/community/Grub2/Upgrading)
...
- [GNU GRUB2 Manual](http://www.gnu.org/software/grub/manual)
- [Illustrated Dual Boot HomePage](http://members.iinet.net/~herman546/p20.html)
- [Mac OS X (XNU) Support](http://en.wikipedia.org/wiki/XNU)
- [Mac OS X Boot Snow Leopard](http://maketecheasier.com/create-a-mac-entry-in-grub2/2010/02/12)
- [GRUB Manual - Themes](http://www.gnu.org/software/grub/manual/html_node/Theme-file-format.html)
- [The Definitive Guide to Theming GRUB2 by Towheed Mohammed](http://ubuntuone.com/2EslXTLj5s2zzbeYKx17wJ)
- [Analysis of problems with grub2 and RAID1 with workarounds](http://dione.no-ip.org/wordpress/computing/debian-squeeze-raid1-and-grub2/)
